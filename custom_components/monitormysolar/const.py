        ...
        "Lux": {
            "sensor": {
                "inputbank1": [
                    ...
                    {"name": "House Consumption (Live)", "type": "sensor", "unique_id": "pload", "state_class": "measurement", "device_class": "wattage"},
                    ...
                    {"name": "Power to Grid (live)", "type": "sensor", "unique_id": "ptogrid", "state_class": "measurement", "unit": "W"},
                    {"name": "Power to User(live)", "type": "sensor", "unique_id": "ptouser", "state_class": "measurement", "unit": "W"},
                    {"name": "Energy PV1 Day", "type": "sensor", "unique_id": "epv1_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy PV2 Day", "type": "sensor", "unique_id": "epv2_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy PV3 Day", "type": "sensor", "unique_id": "epv3_day", "state_class": "total_increasing", "unit": "kWh", "allowed_device_types": ["E", "F", "G"]},
                    {"name": "Energy Inverter Day", "type": "sensor", "unique_id": "einv_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy Rectifier Day", "type": "sensor", "unique_id": "erec_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy Charge Day", "type": "sensor", "unique_id": "echg_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy Discharge Day", "type": "sensor", "unique_id": "edischg_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy EPS Day", "type": "sensor", "unique_id": "eeps_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy to Grid Day", "type": "sensor", "unique_id": "etogrid_day", "state_class": "total_increasing", "unit": "kWh"},
                    {"name": "Energy to User Day", "type": "sensor", "unique_id": "etouser_day", "state_class": "total_increasing", "unit": "kWh"},
                ...
                "inputbank2": [
                    {"name": "Energy PV1 All", "type": "sensor", "unique_id": "epv1_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy PV2 All", "type": "sensor", "unique_id": "epv2_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy PV3 All", "type": "sensor", "unique_id": "epv3_all", "state_class": "total", "unit": "kWh", "allowed_device_types": ["E", "F", "G"]},
                    {"name": "Energy Inverter All", "type": "sensor", "unique_id": "einv_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy Rectifier All", "type": "sensor", "unique_id": "erec_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy Charge All", "type": "sensor", "unique_id": "echg_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy Discharge All", "type": "sensor", "unique_id": "edischg_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy EPS All", "type": "sensor", "unique_id": "eeps_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy to Grid All", "type": "sensor", "unique_id": "etogrid_all", "state_class": "total", "unit": "kWh"},
                    {"name": "Energy to User All", "type": "sensor", "unique_id": "etouser_all", "state_class": "total", "unit": "kWh"},
                    ...
                    {"name": "Battery Temperature", "type": "sensor", "unique_id": "tbat", "state_class": "total", "unit": "°C"},
